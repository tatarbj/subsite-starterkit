...
------|---------|-----------
Webserver|[localhost:1025](http://localhost:1025)|[192.168.33.141](http://192.168.33.141)
...
------|---------|-----------
php-fpm|php5-6-php-fpm|9000
MySQL|php5-6-mysql|3306 (default)
...
**Note 2:** if you're using Vagrant, you'll need to ssh into it first
  ...
  * Execute command inside of container: `docker exec -it php5-6-php-fpm COMMAND` where `COMMAND` is whatever you want to run. For instance, `/bin/bash` to open a console prompt.
